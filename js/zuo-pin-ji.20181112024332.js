...
$('.js-167').mouseenter(function() { $.loadImages('images/ping-mu-kuai-zhao-2018-11-12-shang-wu1.31.57-994.png', function() { }) });
$('.js-167').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-167-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/ping-mu-kuai-zhao-2018-11-12-shang-wu1.31.57-994.png'; } } });
$('.js-161 .slider').slick({lazyLoad: 'ondemand',slidesToShow: 1,slidesToScroll: 1,speed: 600,dots: false,arrows: true,infinite: true});$('.js-168').mouseenter(function() { $.loadImages('images/wechatimg106-3024.jpeg', function() { }) });
$('.js-168').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-168-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/wechatimg106-3024.jpeg'; } } });
$('.js-162 .slider').slick({lazyLoad: 'ondemand',slidesToShow: 1,slidesToScroll: 1,speed: 300,dots: false,arrows: true,infinite: true});$('.js-169').mouseenter(function() { $.loadImages('images/pei-tian-xie-sheng1-2848.jpeg', function() { }) });
$('.js-169').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-169-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/pei-tian-xie-sheng1-2848.jpeg'; } } });
$('.js-163 .slider').slick({lazyLoad: 'ondemand',slidesToShow: 1,slidesToScroll: 1,speed: 300,dots: false,arrows: true,infinite: true});
});