...
$('.js-158').mouseenter(function() { $.loadImages((window.devicePixelRatio > 1) ? 'images/wei-biao-ti-1-3200.png' : 'images/wei-biao-ti-1-1600.png', function() { }) });
$('.js-158').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-158-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = (window.devicePixelRatio > 1) ? 'images/wei-biao-ti-1-3200.png' : 'images/wei-biao-ti-1-1600.png'; } } });
$('.js-159').mouseenter(function() { $.loadImages('images/dan-xing-yue-1128.jpg', function() { }) });
$('.js-159').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-159-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/dan-xing-yue-1128.jpg'; } } });
$('.js-160').mouseenter(function() { $.loadImages('images/ping-mu-kuai-zhao-2018-11-12-shang-wu1.26.27-1079.png', function() { }) });
$('.js-160').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-160-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/ping-mu-kuai-zhao-2018-11-12-shang-wu1.26.27-1079.png'; } } });
